...
<form action="<?php echo JRoute::_('index.php?option=com_travelentity&view=tripsmovesoptions'); ?>" method="post"  name="adminForm" id="adminForm">
  <fieldset id="filter-bar">
    <div class="filter-select fltrt">
   	<select name="filter_trip_move_id" class="inputbox" onchange="this.form.submit()">
		<option value=""><?php echo JText::_('TE_SELECT_TRIPMOVE');?></option>
		<?php echo JHtml::_('select.options', $this->GetMovesList(), 'value', 'text', 0 ? 0 : $this->state->get('filter.trip_move'));?>
	</select>
    </div>
  </fieldset>
