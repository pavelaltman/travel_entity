...
<form action="<?php echo JRoute::_('index.php?option=com_travelentity&view=tripsstaypoints'); ?>" method="post"  name="adminForm" id="adminForm">
  <fieldset id="filter-bar">
    <div class="filter-select fltrt">
   	<select name="filter_trip_id" class="inputbox" onchange="this.form.submit()">
		<option value=""><?php echo JText::_('TE_SELECT_TRIP');?></option>
		<?php echo JHtml::_('select.options', $this->GetTripList(), 'value', 'text', 0 ? 0 : $this->state->get('filter.trip_id'));?>
	</select>
    </div>
  </fieldset>
