...
<?php foreach($this->items as $i => $item): ?>
  ...
  <td>
  <a href="<?php echo JRoute::_('index.php?option=com_travelentity&task=pointslink.edit&points_links_id=' . $item->points_links_id.'&point_id=' . $item->link_point); ?>">
  <?php echo $item->link_link; ?>
  </a>
  </td>
  </tr>
<?php endforeach; ?>
