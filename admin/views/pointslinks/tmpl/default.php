...
<form action="<?php echo JRoute::_('index.php?option=com_travelentity&view=pointslinks'); ?>" method="post"  name="adminForm" id="adminForm">
  <fieldset id="filter-bar">
    <div class="filter-select fltrt">
   	<select name="filter_link_point" class="inputbox" onchange="this.form.submit()">
		...
		<?php echo JHtml::_('select.options', $this->GetPointList(), 'value', 'text', 0 ? 0 : $this->state->get('filter.link_point'));?>
	</select>
    </div>
  </fieldset>
  <div class="clr"> </div>
